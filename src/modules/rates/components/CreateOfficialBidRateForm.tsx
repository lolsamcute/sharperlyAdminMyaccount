...
import { useOfficialBidRateForm } from "../hooks/useOfficialBidRateForm";
...
const CreateOfficialBidRateForm = () => {
  const { form } = useOfficialBidRateForm();
...
export default CreateOfficialBidRateForm;
